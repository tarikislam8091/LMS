        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default btn-squared">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" action="{{ url('/color/update/id-'.$edit->id) }}"
                          id="color" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="color_name" value="{{isset($edit)? $edit->color_name :''}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">
                                <strong>color Image</strong>(Ratio: 150x150)
                            </label>
                            <div class="col-sm-9">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <?php
                                    if ($edit->color_image != '') {
                                        $color_image = $edit->color_image;
                                    } else {
                                        $color_image = '/assets/images/default.jpg';
                                    }
                                    ?>
                                    <div class="fileupload-new thumbnail" style="width: 150px; height: 150px;">
                                        <img width="150px" height="150px" src="{{asset($color_image)}}" alt="">
                                    </div>
                                    ...
                                    <div class="user-edit-image-buttons">
                                        <span class="btn btn-light-grey btn-file">
                                            ...
                                            <input type="file" name="color_image" value="{{ $edit->color_image }}">
                                        </span>
