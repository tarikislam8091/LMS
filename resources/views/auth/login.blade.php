...
<!-- start: HEAD -->
<head>
    <title>Login | ISHO TEST CMS</title>
    <!-- start: META -->
    <meta charset="utf-8" />
...
<div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="logo" style="color: #fff">
        ISHO TEST <i class="clip-lamp"></i> CMS
    </div>
    <!-- start: LOGIN BOX -->
    <div class="box-login btn-squared">
        ...
        <form class="form-login" action="{{ url('auth/post/login') }}" method="post">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <span class="input-icon">
                        <!-- <strong>Are you register user?</strong> -->
                    </span>
                </div>
    ...
    <!-- start: COPYRIGHT -->
    <div class="copyright">
        <span style="color: #fff">&copy; Copyright 2020 by ISHO TEST CMS.Powered by</span> 
        <!-- <a href="http://www.live-technologies.net/" target="_blank">Live Technologies.</a> -->
    </div>
    <!-- end: COPYRIGHT -->
</div>
